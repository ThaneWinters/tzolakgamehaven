...
export const DEFAULT_DEMO_THEME: DemoThemeSettings = {
  ...
  sidebarLightness: 20,
  // Dark mode defaults - match CSS .dark values (warm brown theme)
  darkPrimaryHue: 142,
  darkPrimarySaturation: 35,
  darkPrimaryLightness: 45,
  darkAccentHue: 18,
  darkAccentSaturation: 45,
  darkAccentLightness: 45,
  darkBackgroundHue: 25,
  darkBackgroundSaturation: 30,
  darkBackgroundLightness: 10,
  darkCardHue: 25,
  darkCardSaturation: 28,
  darkCardLightness: 14,
  darkSidebarHue: 25,
  darkSidebarSaturation: 35,
